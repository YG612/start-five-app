...
describe('GAP-P0-03A deterministic reminder planning policy', () => {
  ...
  it('returns detached intents and never embeds task title, description, or first-step text', () => {
    ...
    input.task.startAt = '2099-01-01T00:00:00.000Z';
    input.task.scheduledStartAt = '2099-01-01T00:00:00.000Z';
    expect(firstIntent.triggerAt).toBe('2026-08-05T08:00:00.000Z');
