...
describe('GAP-P0-03A Review1 durable operation preflight and byte-only replay', () => {
  it('replays from copied bytes before a forbidden context and returns a deeply isolated result on every command', async () => {
    ...
    Object.defineProperty(replay, 'privateText', {
      value: 'CALLER_MUTATED_PRIVATE_TEXT',
      configurable: true,
    });
    Object.defineProperty(suggestion, 'value', {
      value: 'CALLER_MUTATED_SUGGESTION',
      configurable: true,
    });
