...
if (mode !== 'spread' && mode !== 'add-canonical') {
  throw new Error('QUALITY_GATE_V2_REVIEW2_ENTRY_MODE_INVALID');
}
...
if (pathKeys.length !== 1) {
  throw new Error('QUALITY_GATE_V2_REVIEW2_OUTER_PATH_IDENTITY_INVALID');
}
...
if (mode === 'add-canonical') {
  if (
    ...
    throw new Error('QUALITY_GATE_V2_REVIEW2_CANONICAL_PATH_REQUIRED');
  }
