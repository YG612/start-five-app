...
const styles = StyleSheet.create({
  ...
  row: {minHeight: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderTopColor: APP_PAGE_TOKENS.light.border, borderTopWidth: StyleSheet.hairlineWidth, paddingVertical: 9},
  rowLabel: {flex: 1, color: APP_PAGE_TOKENS.light.text, fontSize: 15, fontWeight: '700'},
  rowValue: {color: APP_PAGE_TOKENS.light.textMuted, fontSize: 14},
